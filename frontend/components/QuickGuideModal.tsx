    ...
    return (
        ...
        >
            <motion.div
                ...
                className="dark:bg-[#0d0d0d] bg-white dark:text-gray-300 text-neutral-800 w-[90vw] h-[90vh] max-w-7xl rounded-2xl border dark:border-border border-neutral-200 shadow-2xl flex overflow-hidden relative"
            >
                ...
                {/* Left Sidebar */}
                <aside className="w-80 dark:bg-[#131313] bg-neutral-100 border-r dark:border-border/50 border-neutral-200 p-6 flex flex-col shrink-0 overflow-y-auto">
