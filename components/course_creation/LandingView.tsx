...
const CourseCard: React.FC<{ course: Course, onResume: () => void, onPreview: () => void }> = ({ course, onResume, onPreview }) => {
    return (
        <div className="dark:bg-[#1a1a1a] bg-white border dark:border-gray-800 border-neutral-200 rounded-2xl p-6 mb-6 transition-all duration-300 hover:shadow-lg">
            ...
            <h3 
                onClick={onPreview}
                className="text-xl font-bold text-black dark:text-white mb-2 leading-tight cursor-pointer hover:underline decoration-black dark:decoration-white decoration-2 underline-offset-2 transition-all"
            >
                {course.title}
            </h3>
...
const LandingView: React.FC<LandingViewProps> = ({ onSelectCourse, onPreviewCourse, courses, onStartFlow }) => {
    ...
    return (
        <div className="w-full h-full overflow-y-auto custom-scrollbar">
            <div className="w-full max-w-7xl mx-auto flex flex-col p-8 lg:p-12">
                            ...
                            {voiceModeState === 'idle' ? (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center justify-center flex-1 py-14">
                                        ...
                                        <h3 className="text-[26px] font-bold dark:text-gray-400 text-neutral-500 mb-14 tracking-tight">Learn with Stephen</h3>
